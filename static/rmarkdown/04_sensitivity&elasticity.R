...
# First we need the stable stage distribution and Lambda. We could get those from eigen analysis (as in the next section)
# but let's just do it numerically with a simulation. 
